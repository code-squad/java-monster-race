...
public class Menu {
  ...
  private void modifyMonster() {
    ...
    try {
      ...
      if (name.equals("") || !isDuplicatedName(name)) {
  ...
  private void modifyMonsterType(String input) {
    ...
    try {
      ...
      if (!type.equals(MonsterType.RUNNING.getName()) && !type.equals(MonsterType.FLYING.getName())
  ...
  private void createMonster(String name, String type) {
    ...
    if (type.equals(MonsterType.FLYING.getName())) {
      monsters.getMonsters().put(name, new Flying(name));
    }
    if (type.equals(MonsterType.PSYCHIC.getName())) {
      monsters.getMonsters().put(name, new Psychic(name));
    }
  }
